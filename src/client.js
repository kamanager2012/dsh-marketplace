...
export const DEFAULT_REGISTRY_URL = 'https://raw.githubusercontent.com/kamanager2012/dsh-community-plugins/main/catalog.json';
export async function fetchCatalog(options = {}) {
    ...
    try {
        ...
        if (catalog === undefined)
            throw new Error('registry catalog failed schema validation');
...
export function defaultCachePath(homeDir) {
